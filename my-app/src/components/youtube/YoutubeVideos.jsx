...
useEffect(()=>{
    const url =(`https://youtube.googleapis.com/youtube/v3/search?part=snippet&channelId=UCE_M8A5yxnLfW0KghEeajjw&maxResults=8&order=date&key=${API_KEY}`)
fetch(url)
.then(response=>{
  ...
  return (
    <>
      <section className="youtubeVideosWrapper">
        ...
        <div className="videosWrapper col-6 col-12-sm">
